...
export type commandName = commandName_1 | commandName_2 | commandName_3 | commandName_4 | commandName_5 | commandName_6 | commandName_7 | commandName_8;
...
export class Parser {
    ...
    public matchdropCommand($$dpth: number, $$cr?: ErrorTracker): Nullable<dropCommand> {
    ...
    public matchdropKeyword($$dpth: number, $$cr?: ErrorTracker): Nullable<dropKeyword> {
        return this.regexAccept(String.raw`(?:drop)`, $$dpth + 1, $$cr);
    }
    public matchtakeCommand($$dpth: number, $$cr?: ErrorTracker): Nullable<takeCommand> {
    ...
    public matchhelpCommand_1($$dpth: number, $$cr?: ErrorTracker): Nullable<helpCommand_1> {
    ...
    public matchhelpCommand_2($$dpth: number, $$cr?: ErrorTracker): Nullable<helpCommand_2> {
    ...
    public matchcommandName_8($$dpth: number, $$cr?: ErrorTracker): Nullable<commandName_8> {
    ...
    public matchmove_1($$dpth: number, $$cr?: ErrorTracker): Nullable<move_1> {
        return this.run<move_1>($$dpth,
            () => {
                ...
                if (true
                    && ($scope$text = this.regexAccept(String.raw`(?:move)`, $$dpth + 1, $$cr)) !== null
                ) {
    ...
    public matchexit_1($$dpth: number, $$cr?: ErrorTracker): Nullable<exit_1> {
        return this.run<exit_1>($$dpth,
            () => {
                ...
                if (true
                    && ($scope$text = this.regexAccept(String.raw`(?:exit)`, $$dpth + 1, $$cr)) !== null
                ) {
    ...
    public matchexit_2($$dpth: number, $$cr?: ErrorTracker): Nullable<exit_2> {
        return this.run<exit_2>($$dpth,
            () => {
                ...
                if (true
                    && ($scope$text = this.regexAccept(String.raw`(?:exits)`, $$dpth + 1, $$cr)) !== null
                ) {
    ...
    public matchtake_1($$dpth: number, $$cr?: ErrorTracker): Nullable<take_1> {
        return this.run<take_1>($$dpth,
            () => {
                ...
                if (true
                    && ($scope$text = this.regexAccept(String.raw`(?:take)`, $$dpth + 1, $$cr)) !== null
                ) {
    ...
    public matchdrop_1($$dpth: number, $$cr?: ErrorTracker): Nullable<drop_1> {
        return this.run<drop_1>($$dpth,
            () => {
                ...
                if (true
                    && ($scope$text = this.regexAccept(String.raw`(?:drop)`, $$dpth + 1, $$cr)) !== null
                ) {
    ...
    public matchsay_1($$dpth: number, $$cr?: ErrorTracker): Nullable<say_1> {
        return this.run<say_1>($$dpth,
            () => {
                ...
                if (true
                    && ($scope$text = this.regexAccept(String.raw`(?:say)`, $$dpth + 1, $$cr)) !== null
                ) {
    ...
    public matchinventory_1($$dpth: number, $$cr?: ErrorTracker): Nullable<inventory_1> {
        return this.run<inventory_1>($$dpth,
            () => {
                ...
                if (true
                    && ($scope$text = this.regexAccept(String.raw`(?:inventory)`, $$dpth + 1, $$cr)) !== null
                ) {
    ...
    public matchwhisper_1($$dpth: number, $$cr?: ErrorTracker): Nullable<whisper_1> {
        return this.run<whisper_1>($$dpth,
            () => {
                ...
                if (true
                    && ($scope$text = this.regexAccept(String.raw`(?:whisper)`, $$dpth + 1, $$cr)) !== null
                ) {
