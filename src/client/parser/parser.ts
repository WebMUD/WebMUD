...
export class Parser {
  ...
  public matchcommands_10(
    $$dpth: number,
    $$cr?: ErrorTracker
  ): Nullable<commands_10> {
  ...
  public matchshortenedMoveCommand(
    $$dpth: number,
    $$cr?: ErrorTracker
  ): Nullable<shortenedMoveCommand> {
